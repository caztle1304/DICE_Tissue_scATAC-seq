...
lungCD4.outputDirectory <- '/mnt/bioadhoc-temp/Groups/vd-vijay/acastillo/R24/singleLane_4paper/projects/lungCD4_R24_P_Hu_2_CD4_4D_ATAC_TSS10_nFragslog3.5_varFeats30k'
createArchRProject(lungCD4.inputFile,lungCD4.sample, lungCD4.outputDirectory, 3162, 10)
...
lungCD8.outputDirectory <- '/mnt/bioadhoc-temp/Groups/vd-vijay/acastillo/R24/singleLane_4paper/projects/lungCD8_R24_P_Hu_3_CD8_4D_ATAC_TSS10_nFragslog3.5_varFeats30k'
createArchRProject(lungCD8.inputFile, lungCD8.sample, lungCD8.outputDirectory, 3162, 10)
...
myeloid2.outputDirectory <- '/mnt/bioadhoc-temp/Groups/vd-vijay/acastillo/R24/singleLane_4paper/projects/myeloid_R24DICE_Hu_M2_mye_ATAC_TSS8_nFragslog3.5_varFeats30k'
createArchRProject(myeloid2.inputFile, myeloid2.sample, myeloid2.outputDirectory, 3162, 8)
...
NK1.outputDirectory <- '/mnt/bioadhoc-temp/Groups/vd-vijay/acastillo/R24/singleLane_4paper/projects/NK_R24DICE_Hu_N1_NK_ATAC_TSS8_nFragslog3.5_varFeats30k'
createArchRProject(NK1.inputFile, NK1.sample, NK1.outputDirectory, 3162, 8)
